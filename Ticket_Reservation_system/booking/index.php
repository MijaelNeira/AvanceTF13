...
<title>Generando tu Boleto...</title>
...
<p>Solicitud de pedido .. Solo un segundo </p>
<div id="proceed"></div>
</div>
</div>
<div class="ui attached bottom message">
<div class="ui horizontal divider">Perdiste tu boleto ?</div>
...
<button id="printbtn" class="ui button small blue">Re-imprimir</button>
</form>
<div class="ui horizontal divider">Preguntas frecuentes</div>
...
<script>
setTimeout(function(){document.getElementById("proceed").innerHTML="<a href='booking.php' class='ui button small green'>Done! Proceed</a> <a href='../admin/login.php' class='ui button small orange'>Admin Login</a> "},5000);
</script>
</body>
</html>