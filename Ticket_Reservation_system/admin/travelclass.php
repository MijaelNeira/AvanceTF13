...
<html>
  ...
  <body>
    <div class="ui inverted huge borderless fixed fluid menu">
      <a class="header item">CLASES ITINERANTES</a>
      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="item" href="bookings.php">Reservaciones</a><a class="item " href="transactions.php">Transacciones</a><a class="active item" href="travelclass.php">Clases Itinerantes</a><a class="item">Exportar</a>
	...
	<div class="ui grid">
            <div class="row">
         <h1 class="ui huge header">Todas las clases itinerantes</h1>
         </div>
        <div class="ui horizontal divider"> Todas las clases itinerantes</div>      
		<div class="row">
            <table class="ui single line striped selectable center aligned  table">
<thead><tr><th>Identificador de clase </th><th>Clase de viaje</th><th>clase Capacidad</th><th>Precio de la clase</th><th>Descripción / Oferta</th></tr></thead>
<tbody>
