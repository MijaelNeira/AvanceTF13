...
<html>
  ...
  <body>
    <div class="ui inverted huge borderless fixed fluid menu">
      <a class="header item">SISTEMA DE RESERVA DE BOLETOS DE VIAJE</a>
      <div class="right menu">
        <div class="item">
          <div class="ui small input">
		  <form>
            <input placeholder="Orden de búsqueda ..." name="search" />
			</form>
          </div>
        </div>
        <a class="item" href="logout.php">Cerrar sesion</a>
      </div>
    </div>
      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="active item" href="bookings.php">Reservaciones</a><a class="item" href="transactions.php">Transacciones</a><a class="item" href="travelclass.php">Clases itinerantes</a><a class="item">Exportar</a>
			<a class="item" href="developer.php">Acerca del desarrollador</a>
          </div>
        </div>
	...
	<div class="ui grid">
        ...
        <div class="ui horizontal divider"> Estas son las Reservas los Detalles</div>      
		<?php 
//rejection
...
<thead><tr><th>Numero de Reserva</th><th>Nombre del cliente</th><th>Contacto</th><th>Clase reservada</th><th>Destino</th><th>Nro de Asientos</th><th>Fecha del viaje</th><th>Operacion</th></tr></thead>
<tbody>
<?php
require("../dbengine/dbconnect.php");
